...
<div class="container">
    ...
    <form action="{{ route('barangs.update',$stok_barang->id) }}" method="POST">
        @csrf
        @method('PUT')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="jumlah_stok" value="{{ $stok_barang->jumlah_stok }}" class="form-control" placeholder="Harga">
                </div>
            </div>
